...
def main(params_override: Optional[Dict[str, Any]] = None, *, make_plots: bool = True, save_results: bool = True, outdir: Optional[Path] = None) -> SimRunResult:
    ...
    return SimRunResult(
        outdir=OUTDIR, x=x, times=times, Tw_hist=Tw_hist, Tg_hist=Tg_hist, Ti_hist=Ti_hist,
        wall_time_s=total_wall, n_steps=n,
    )
